    ...
    return(
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                { user !== null && user.name !== undefined ? <NavButton name={"Conversations"} onClick={null} href={`/users/conversations`}/> : null}
                { user !== null && user.name !== undefined ? <NavButton name={`${user.username}`} onClick={null} href={`/users`}/> : null}
